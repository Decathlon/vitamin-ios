    ...
    private func makeSections() -> [AssetSection] {
        [
            ...
            AssetSection(name: "Flags", items: [
                ...
                AssetItem(name: "VitaminAssets.Flag.do.image", image: VitaminAssets.Flag.do.image),
                ...
                AssetItem(name: "VitaminAssets.Flag.in.image", image: VitaminAssets.Flag.in.image),
                ...
                AssetItem(name: "VitaminAssets.Flag.is.image", image: VitaminAssets.Flag.is.image),
